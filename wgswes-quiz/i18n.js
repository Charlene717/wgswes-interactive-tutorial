/* WGS / WES Quiz · i18n
 * 與 ../i18n.js 同邏輯：
 * - localStorage key 'wgswes_lang'（與教學共用，切換能跨頁同步）
...
(function(){
  ...
  const STR = {
    appTitle:        { zh:"🧬 WGS / WES 互動考題", en:"🧬 WGS / WES Interactive Quiz" },
    ...
    quizAllChapters: { zh:"WGS / WES 互動考題（全部章節）", en:"WGS / WES Interactive Quiz (All Chapters)" },
    quizErrataTitle: { zh:"WGS / WES 互動考題", en:"WGS / WES Interactive Quiz" },
  ...
  document.addEventListener('DOMContentLoaded', ()=>{
    ...
    if(host && !document.getElementById('langToggle')){
      ...
      btn.style.cssText = 'background:#fff;color:#047857;border:1px solid rgba(255,255,255,.5);border-radius:999px;padding:5px 14px;font-size:13px;font-weight:700;cursor:pointer;font-family:inherit;white-space:nowrap';
